  ...
  <div class="carousel-inner">
    ...
    @for($i = 1; $i < count($releaseNumbers); $i++)
      ...
      <div class="slide-info">
        ...
        <div class="image-slide">
        <img src="{{$releaseNumbers[$i]->image->upload_path}}">
        </div>
    </div>
    @endfor
...
<div id="block-new-posts">
    <div id="new-post">
      ...
      <img src="{{$listPost[0]->image->upload_path}}" alt="">
    ...
    <div id="old-post">
        ...
        <img src="{{$listPost[1]->image->upload_path}}" alt="">
        ...
        <div id="old-post-bellow">
            @if(isset($listPost[2]))
            <div>
            <img src="{{$listPost[2]->image->upload_path}}" alt="">
            ...
            @if(isset($listPost[3]))
            <div>
            <img src="{{$listPost[3]->image->upload_path}}" alt="">
